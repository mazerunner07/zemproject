...
export default function PublicProjectDetailPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 p-8">
        ...
        <ProjectBanner editingId={projectData.id} isPrivate={false} bg={projectData.gradient} name={projectData.name} bannerImage={projectData?.bannerImage ?? ""} />
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">{projectData.client.companyName}</p>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{projectData.user.phone}</p>
