...
export default function GuestProjects({ projects, isOwner = false }: { projects: GuestProject[], isOwner?: boolean }) {
  ...
  return (
    <div className="flex flex-col bg-gray-100 rounded-lg w-full h-full dark:bg-[#1E293B] text-gray-900 dark:text-gray-100 p-6">
        ...
        <div className="space-y-4">
          {projects.map((project, index) => {
            ...
            return (
              <div 
                key={index} 
                className="flex md:flex-row justify-between items-center md:items-center p-4 bg-white dark:bg-[#0F172A] rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
              >
