            ...
            >
              {currentProjects.length > 0 ? (
                currentProjects.map((project) => (
                  <motion.div
                    key={project.id}
                    className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden border border-gray-100 dark:border-gray-700"
          ...
          {recentProjects.length > projectsPerPage && (
            <div className="mt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
              <button
                ...
                className="w-full sm:w-auto bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
              >
                Previous
              </button>
