            ...
            <div className="flex justify-end gap-x-2">
                ...
                <div className="relative flex flex-col bg-white shadow-lg rounded-xl pointer-events-auto dark:bg-neutral-800">
                    ...
                    <div className="relative z-10 -mt-12">
                        ...
                        <img src={invoiceDetails?.user?.userLogo ?? "/placeholder.svg"} className='mx-auto flex justify-center items-center size-[62px] rounded-full border border-gray-200 bg-white text-gray-700 shadow-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400' />
                    </div>
